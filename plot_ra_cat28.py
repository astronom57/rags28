...
def get_correction_factors(good_df, bad_df):
    """
    ...
    plt.figure()
    plt.plot(good_df.base_ml, good_df.ampl, 'o', bad_df.base_ml, bad_df.ampl, 'o', xi, yi)
    plt.figure()
    plt.plot(good_df.base_ml, good_df.ampl, 'o', bad_df.base_ml, bad_df.ampl*np.median(correction_factors), 'o', xi, yi)
    plt.figure()
...
# main
    ...
    corr = get_correction_factors(a, c)
    # plt.figure()
    # corr.hist()
    sys.exit()
